...
function showData() {
  ...
  team.forEach((member) => {
    ...
    <div class="max-w-2xl flex items-center h-auto lg:h-64 flex-wrap mx-auto my-8 lg:w-1/4 lg:my-0">
...
<body class = "font-sans antialiased text-gray-900 bg-green-50 leading-normal tracking-wider text-xl lg:text-sm">
   <section class="text-green-700 font-bold text-4xl text-center py-16">
       <h1>Meet The Team</h1>
   </section>
   <section class="bg-gray-700 bg-blend-soft-light bg-cover bg-center lg:bg-fixed lg:h-screen pt-20 lg:flex lg:flex-wrap lg:justify-evenly" style="background-image:url('./assets/images/computer-background.jpg')">
    ${ee.map(card => (`${card}`))}
    </section>
</body>
</html>`
